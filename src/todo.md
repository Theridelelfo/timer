...
- [ ] Ampliare `index.html` con la struttura HTML5 semantica base per la landing page.
- [ ] Ampliare `timer.html` inserendo i tag semantici per il display del timer e i tre pulsanti di controllo.
- [ ] Configurare `style.css` con il layout essenziale e le variabili CSS per la gestione dei colori.
